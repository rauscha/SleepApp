# Scene photo attributions

All photos served from this directory. Sourced under licenses that permit
free use; attribution recorded here per common practice even where the
license does not strictly require it.

| Scene            | File                  | Photographer        | Source / License                          |
|------------------|-----------------------|---------------------|-------------------------------------------|
