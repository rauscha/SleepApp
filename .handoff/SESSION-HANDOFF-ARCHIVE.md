...
Blocks from 2026-08-19 and earlier, split out of `SESSION-HANDOFF.md` on
2026-09-19 to keep the live file readable. Newest first, same as the live
file. Nothing here is current state — it is the trail of how the project got
where it is, and it is occasionally the only record of why something was
tried and dropped.
